...
/**
 * 实现智能体工作流Instance业务服务。
 */
@Service
public class AgentWorkflowInstanceServiceImpl extends ServiceImpl<AgentWorkflowInstanceMapper, AgentWorkflowInstance> implements AgentWorkflowInstanceService {
}
