...
public class WorkflowScheduleTriggerDispatcher {
    ...
    /**
     * 创建 {@code WorkflowScheduleTriggerDispatcher} 实例。
     */
    public WorkflowScheduleTriggerDispatcher(AgentWorkflowScheduleTriggerService triggerService) {
        this.triggerService = triggerService;
    }

    /**
     * 处理triggerDueSchedules。
     */
    ...
    public void triggerDueSchedules() {
        ...
        for (AgentWorkflowScheduleTrigger trigger : triggers)
            triggerService.triggerDue(trigger.getId(), trigger.getNextFireAt());
    }
}
