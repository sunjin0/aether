...
public final class WorkflowVariableRenderer {
    ...
    /**
     * 创建 {@code WorkflowVariableRenderer} 实例。
     */
    ...
    public static String render(String template, Map<String, Object> variables) {
        ...
        while (matcher.find()) {
            ...
            if (!variables.containsKey(key))
                throw new ServerException(422, I18nUtils.getMessage("workflow.variable.not-provided", new Object[]{key}));
            matcher.appendReplacement(output, Matcher.quoteReplacement(String.valueOf(variables.get(key))));
        }
