...
public class ApplicationQuotaService {
    ...
    public void consumeAgentCall(String applicationId) { consume(applicationId, "agent", applicationService.requireActive(applicationId).getMaxAgentCallsPerHour()); }
    public void consumeWorkflowStart(String applicationId) { consume(applicationId, "workflow", applicationService.requireActive(applicationId).getMaxWorkflowStartsPerHour()); }
    private void consume(String appId, String resource, Integer configured) {
        ...
        String key = "AgentApplicationQuota:" + appId + ":" + resource + ":" + bucket;
