...
public class OpenApiAgentRunStartDto {
    ...
    @ApiModelProperty(value = "发送给智能体的用户输入", required = true, example = "Draft a response to this support case.")
    private String input;
    @ApiModelProperty(value = "产品允许的上下文数据", example = "{\"customerTier\":\"gold\"}")
    private Map<String, Object> context;
    @ApiModelProperty(value = "调用方观察到的最后交互序号；仅并发渠道时需要", example = "12")
