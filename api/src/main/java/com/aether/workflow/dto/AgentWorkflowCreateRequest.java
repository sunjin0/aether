...
@Data
public class AgentWorkflowCreateRequest {
    @ApiModelProperty(value = "所属业务应用空间", required = false, example = "app-001") private String applicationId;
    @ApiModelProperty(value = "工作流编码", required = true, example = "order-review") private String code;
    ...
    @ApiModelProperty(value = "节点定义 JSON", required = false, example = "[]") private String nodes;
    @ApiModelProperty(value = "边定义 JSON", required = false, example = "[]") private String edges;
