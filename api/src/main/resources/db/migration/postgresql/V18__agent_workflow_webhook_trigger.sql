...
CREATE TABLE IF NOT EXISTS agent_workflow_webhook_trigger (
    ...
    name VARCHAR(128) NOT NULL, business_type VARCHAR(64) NOT NULL,
    business_id_expression VARCHAR(512) NOT NULL, idempotency_key_expression VARCHAR(512) NOT NULL,
    variable_mapping TEXT NOT NULL DEFAULT '{}', signing_secret TEXT NOT NULL, enabled BOOLEAN NOT NULL DEFAULT TRUE,
    last_triggered_at BIGINT, last_error_message VARCHAR(2048), created_at BIGINT, updated_at BIGINT,
