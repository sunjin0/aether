...
CREATE TABLE IF NOT EXISTS agent_workflow_execution_job (
    id VARCHAR(32) PRIMARY KEY, instance_id VARCHAR(32) NOT NULL, status VARCHAR(24) NOT NULL,
    attempt_count INTEGER NOT NULL DEFAULT 0, next_attempt_at BIGINT, locked_at BIGINT,
    error_message VARCHAR(2048), completed_at BIGINT,
