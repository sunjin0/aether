...
(id, template_id, version, published, config_snapshot, policy_version, published_at, created_at, updated_at, sort_num,
 deleted, state)
VALUES ('sandbox_local_python_v2', 'sandbox_local_python', 2, TRUE,
        ...
        'v2', (EXTRACT(EPOCH FROM clock_timestamp()) * 1000):: BIGINT,
...
SET current_version_id = 'sandbox_local_python_v2'
WHERE id = 'sandbox_local_python';
UPDATE sandbox_execution_template
SET current_version_id = 'sandbox_local_node_v2'
WHERE id = 'sandbox_local_node';
