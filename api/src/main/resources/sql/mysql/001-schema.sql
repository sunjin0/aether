...
CREATE TABLE IF NOT EXISTS `knowledge_base_member` (`id` BIGINT NOT NULL PRIMARY KEY, `knowledge_base_id` BIGINT NOT NULL, `admin_id` BIGINT NOT NULL, `role` VARCHAR(16) NOT NULL, `created_at` BIGINT, `updated_at` BIGINT, `sort_num` INT NOT NULL DEFAULT 0, `deleted` TINYINT NOT NULL DEFAULT 0, `state` INT NOT NULL DEFAULT 0, UNIQUE KEY `uk_kb_member` (`knowledge_base_id`,`admin_id`,`deleted`));
