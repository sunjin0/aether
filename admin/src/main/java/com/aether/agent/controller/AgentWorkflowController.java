...
import com.aether.agent.dto.AgentWorkflowTemplateDto;
...
import com.aether.agent.vo.AgentWorkflowWebhookTriggerVo;
...
import com.aether.agent.vo.AgentWorkflowVersionVo;
import com.aether.agent.vo.AgentWorkflowVersionDiffVo;
...
public class AgentWorkflowController {
    ...
    public WebResponse<com.aether.agent.entity.AgentWorkflowTemplate> createTemplate(@PathVariable String id, @RequestBody AgentWorkflowTemplateDto dto) {
        AgentWorkflow workflow = required(id);
    ...
    public WebResponse<List<com.aether.agent.entity.AgentWorkflowTemplate>> templates(@RequestBody(required = false) AgentWorkflowTemplateDto query) {
        return WebResponse.OK(templateService.list(Wrappers.lambdaQuery(com.aether.agent.entity.AgentWorkflowTemplate.class)
                .like(query != null && StringUtils.isNotBlank(query.getName()), com.aether.agent.entity.AgentWorkflowTemplate::getName, query == null ? null : query.getName())
                .eq(com.aether.agent.entity.AgentWorkflowTemplate::getDeleted, false).orderByDesc(com.aether.agent.entity.AgentWorkflowTemplate::getCreatedAt)));
    }
    ...
    @Permission(path = "/workflow/workflow/run", type = Permission.Type.Write)
    ...
    public WebResponse<List<AgentWorkflowWebhookTriggerVo>> webhooks(@RequestBody AgentWorkflowWebhookTriggerVo query) {
        Page<com.aether.agent.entity.AgentWorkflowWebhookTrigger> page = webhookTriggerService.page(
                new Page<com.aether.agent.entity.AgentWorkflowWebhookTrigger>(query.getCurrent(), query.getPageSize()),
                Wrappers.lambdaQuery(com.aether.agent.entity.AgentWorkflowWebhookTrigger.class)
                        .eq(StringUtils.isNotBlank(query.getWorkflowId()), com.aether.agent.entity.AgentWorkflowWebhookTrigger::getWorkflowId, query.getWorkflowId())
                        .eq(com.aether.agent.entity.AgentWorkflowWebhookTrigger::getDeleted, false)
                        .orderByDesc(com.aether.agent.entity.AgentWorkflowWebhookTrigger::getCreatedAt));
    ...
    public WebResponse<com.aether.agent.entity.AgentWorkflowScheduleTrigger> createSchedule(@RequestBody AgentWorkflowScheduleTriggerDto dto) {
    ...
    public WebResponse<List<com.aether.agent.entity.AgentWorkflowScheduleTrigger>> schedules(@RequestBody(required = false) com.aether.agent.entity.AgentWorkflowScheduleTrigger query) {
        return WebResponse.OK(scheduleTriggerService.list(Wrappers.lambdaQuery(com.aether.agent.entity.AgentWorkflowScheduleTrigger.class)
                .eq(query != null && StringUtils.isNotBlank(query.getWorkflowId()), com.aether.agent.entity.AgentWorkflowScheduleTrigger::getWorkflowId, query == null ? null : query.getWorkflowId())
                .eq(com.aether.agent.entity.AgentWorkflowScheduleTrigger::getDeleted, false).orderByDesc(com.aether.agent.entity.AgentWorkflowScheduleTrigger::getCreatedAt)));
    }
    ...
    @ApiOperation("流程实例列表")
    @Permission(path = "/workflow/workflow/run")
